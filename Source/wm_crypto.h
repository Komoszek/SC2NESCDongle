...
const unsigned char sboxes[10][256]  = {
	{
...
void wm_gentabs()
{
    ...
    for(idx = 0; idx < 7; idx++){
        ...
        if (osal_memcmp(tkey, (void *) wm_key, 6) == 0) break; // if match, then use this idx
    }

    // generate encryption from idx key and rand
    wm_ft[0] = ((sboxes[idx + 1][wm_key[4]])) ^ ((sboxes[idx + 2][wm_rand[3]]));
    wm_ft[1] = ((sboxes[idx + 1][wm_key[2]])) ^ ((sboxes[idx + 2][wm_rand[5]]));
    wm_ft[2] = ((sboxes[idx + 1][wm_key[5]])) ^ ((sboxes[idx + 2][wm_rand[7]]));
    wm_ft[3] = ((sboxes[idx + 1][wm_key[0]])) ^ ((sboxes[idx + 2][wm_rand[2]]));
    wm_ft[4] = ((sboxes[idx + 1][wm_key[1]])) ^ ((sboxes[idx + 2][wm_rand[4]]));
    wm_ft[5] = ((sboxes[idx + 1][wm_key[3]])) ^ ((sboxes[idx + 2][wm_rand[9]]));
    wm_ft[6] = ((sboxes[idx + 1][wm_rand[0]])) ^ ((sboxes[idx + 2][wm_rand[6]]));
    wm_ft[7] = ((sboxes[idx + 1][wm_rand[1]])) ^ ((sboxes[idx + 2][wm_rand[8]]));

    wm_sb[0] = ((sboxes[idx + 1][wm_key[0]])) ^ ((sboxes[idx + 2][wm_rand[1]]));
    wm_sb[1] = ((sboxes[idx + 1][wm_key[5]])) ^ ((sboxes[idx + 2][wm_rand[4]]));
    wm_sb[2] = ((sboxes[idx + 1][wm_key[3]])) ^ ((sboxes[idx + 2][wm_rand[0]]));
    wm_sb[3] = ((sboxes[idx + 1][wm_key[2]])) ^ ((sboxes[idx + 2][wm_rand[9]]));
    wm_sb[4] = ((sboxes[idx + 1][wm_key[4]])) ^ ((sboxes[idx + 2][wm_rand[7]]));
    wm_sb[5] = ((sboxes[idx + 1][wm_key[1]])) ^ ((sboxes[idx + 2][wm_rand[8]]));
    wm_sb[6] = ((sboxes[idx + 1][wm_rand[3]])) ^ ((sboxes[idx + 2][wm_rand[5]]));
    wm_sb[7] = ((sboxes[idx + 1][wm_rand[2]])) ^ ((sboxes[idx + 2][wm_rand[6]]));
}
